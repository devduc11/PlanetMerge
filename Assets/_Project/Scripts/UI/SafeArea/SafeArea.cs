...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        [SerializeField] bool top = true;  // Conform to screen safe area on Y-axis top (default true, disable to ignore)
        [SerializeField] bool bot = true;  // Conform to screen safe area on Y-axis bot (default true, disable to ignore)
        ...
        void ApplySafeArea(Rect r)
        {
            ...
            if (Screen.width > 0 && Screen.height > 0)
            {
                ...
                if (anchorMin.x >= 0 && anchorMin.y >= 0 && anchorMax.x >= 0 && anchorMax.y >= 0)
                {
                    ...
                    Panel.anchorMin = new Vector2(anchorMin.x, bot ? anchorMin.y : 0);
                    Panel.anchorMax = new Vector2(anchorMax.x, top ? anchorMax.y : 1);
                    ApplySafeArea(Panel);
                }
            }
        ...
        protected virtual void ApplySafeArea(RectTransform safeRectTransform)
        {
