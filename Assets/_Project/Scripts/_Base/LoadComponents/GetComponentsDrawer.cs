...
[CustomPropertyDrawer(typeof(GetComponentsAttribute))]
public class GetComponentsDrawer : PropertyDrawer
{
    ...
    {
        GetComponentsAttribute attr = (GetComponentsAttribute)attribute;
        ...
        if (property.isExpanded)
        {
            ...
            if (arrayProperty != null && arrayProperty.isArray)
            {
                ...
                Component[] components = gameObject.GetComponents(attr.type);
